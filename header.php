...
<html <?php language_attributes(); ?>>
	<head>
		...
		<link rel="stylesheet" type="text/css" media="all" href="<?php echo get_stylesheet_uri(); ?>?v="<?php echo GP_THEME_VERSION; ?>>

		<?php gp_the_css_for_custom_colors(); ?>

		<!-- <link rel="shortcut icon" href="<?php echo get_template_directory_uri(); ?>/favicon.ico?v="<?php echo GP_THEME_VERSION; ?> /> -->
